...
<head>
    ...
    <meta name="route-store-inscription" content="{{ route('store_inscription') }}">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    @vite(['resources/css/app.css','resources/js/inscription-script.js'])
    ...
    <div class="bg-white shadow-md px-5 py-1 flex justify-between items-center fixed w-full">
        ...
        <div class="flex space-x-6 items-center">
            ...
            @else
                ...
                <a href="{{route('inscription')}}" class="text-darkgray-700 hover:text-blue-600 text-[13px] font-bold">Inscription</a>
            @endif
        </div>
    </div>
    <div class="w-full h-screen grid place-items-center bg-gray-100 py-25 overflow-auto">
        <form id="inscriptionForm" class="bg-white px-8 py-6 rounded-lg shadow-lg max-w-md w-full">
        @csrf <!-- Protection CSRF obligatoire dans Laravel -->

            <!-- Titre -->
            <h2 class="text-center text-2xl font-bold text-gray-700 mb-6">Inscription</h2>

            <!-- Message global -->
            <div id="global-message" class="hidden text-green-700 font-bold mb-4 text-center bg-green-50 p-1 rounded border border-green-300"></div>
            ...
            <div class="mb-4">
                ...
                <span id="pseudo-error" class="text-red-600 text-[13px] mt-1 block error-message"></span>
            </div>
            ...
            <div class="mb-4">
                ...
                <input id="telephone1" type="text" name="telephone1" value="{{ old('telephone1') }}"
                       class="w-full h-7 px-3 border border-gray-300 rounded-md focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none text-sm">
                <span id="telephone1-error" class="text-red-600 text-[13px] mt-1 block error-message"></span>
            </div>

            <!-- Champ Email -->
            <div class="mb-4">
                <label for="email" class="block mb-2 font-semibold text-gray-600">Email</label>
                <input id="email" type="email" name="email" value="{{ old('email') }}"
                       class="w-full h-7 px-3 border border-gray-300 rounded-md focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none text-sm">
                <span id="email-error" class="text-red-600 text-[13px] mt-1 block error-message"></span>
            </div>
            ...
            <div class="mb-4">
                ...
                <input id="password" type="password" name="password"
                       class="w-full h-7 px-3 border border-gray-300 rounded-md focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none text-sm">
                <span id="password-error" class="text-red-600 text-[13px] mt-1 block error-message"></span>
            </div>
            ...
            <div class="mb-6">
                ...
                <input id="password_confirmation" type="password" name="password_confirmation"
                       class="w-full h-7 px-3 border border-gray-300 rounded-md focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none text-sm">
                <span id="password_confirmation-error" class="text-red-600 text-[13px] mt-1 block"></span>
            </div>
